          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              <p style={{ fontSize: "clamp(16px, 1.3vw, 20px)", color: "#6b7280", lineHeight: 1.8, marginBottom: 24 }}>
                A photo booth at your festival draws people in, keeps them engaged, and gives every attendee a tangible memory to take home. From quirky props to colorful branded backdrops, our booth becomes one of the highlights of the day.
              </p>
              <p style={{ fontSize: "clamp(15px, 1.1vw, 17px)", color: "#9ca3af", lineHeight: 1.8 }}>
                Whether you're running a local community event, a music festival, or a cultural celebration, we bring a professional setup that handles high volume with ease. Custom branding, unlimited prints, and instant social sharing — all included.
              </p>
            </div>
          </RevealOnScroll>
        </div>
...
const festivalSections: SectionData[] = [
  {
    ...
    body: "Our photo booth is designed to engage festival-goers and bring strangers together through shared fun. It creates a natural gathering point on the grounds — guests find it, use it, and come back. The energy it generates spreads through the whole event.",
  ...
  },
  {
    ...
    imageAlt: "Branded mirror photo booth at a festival",
    ...
    body: "Every photo becomes a branded touchpoint. Custom photo frames and backgrounds featuring your festival logo, sponsors, or theme turn each print into a keepsake that also promotes your event — long after the gates close.",
  ...
  },
  {
    ...
    imageAlt: "Festival-themed photo props and accessories",
    label: "Props & Prints",
    heading: (
      <>
    ...
    body2: "Every guest can print as many photos as they want, ensuring everyone leaves with a tangible memory of your event. No limits, no upsells — unlimited prints are included in every package.",
  },
  {
    bg: "#fff",
    imageLeft: false,
    ...
    body: "Our team handles everything — coordinating with your event logistics, arriving early, setting up in your chosen location, and staffing the booth for the full duration. No headaches, no surprises.",
...
const festivalFaqs = [
  {
    q: "How far in advance should I book a photo booth for a festival?",
    a: "For festivals and larger events, we recommend booking 6–8 weeks in advance, particularly for summer dates. Multi-day festivals or events requiring multiple booths should reach out even earlier.",
  },
  {
    q: "Can the photo booth be branded with our festival's logo?",
    a: "Yes — custom photo frames featuring your festival branding, sponsors, or theme are included in every package at no extra cost. We can also create custom backdrop options to match your event's visual identity.",
  },
  {
    q: "Can the booth handle high foot traffic at a large festival?",
    a: "Absolutely. Our classic Salsa Photo Booth is built for high-volume events and moves guests through efficiently. For larger festivals, we can discuss running multiple booths to ensure no one waits too long.",
  },
  {
  ...
  {
    q: "Can guests share photos to social media directly from the booth?",
    a: "Yes. Our booths support instant sharing to Instagram, Facebook, and more. Guests can text or email their photos on the spot. This drives real-time social coverage of your event organically.",
  },
  {
    q: "What's included in a festival photo booth rental?",
  ...
  {
    q: "Do you do multi-day festivals or outdoor events?",
    a: "Yes — we accommodate multi-day events and outdoor setups. Reach out with your event details and we'll put together a package that fits your specific requirements, including weather considerations for outdoor venues.",
  },
];
    ...
    <>
      ...
      <main>
        <ActivityHero
          ...
          subtext="Add an extra layer of excitement to your festival — with vibrant props, branded frames, unlimited prints, and an experience your attendees will be talking about long after the last set ends."
          ctaText="Book Your Festival Booth"
          ctaColor="#FF6B35"
          bgSrc="/festivals-and-events.jpg"
          bgAlt="Festival photo booth setup"
