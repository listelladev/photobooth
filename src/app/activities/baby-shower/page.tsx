          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              <p style={{ fontSize: "clamp(16px, 1.3vw, 20px)", color: "#6b7280", lineHeight: 1.8, marginBottom: 24 }}>
                A photo booth turns your baby shower into something everyone remembers long after the cake is cut. Guests step in, pick their props, and walk away with a printed memory in hand — it runs itself while you enjoy your celebration.
              </p>
              <p style={{ fontSize: "clamp(15px, 1.1vw, 17px)", color: "#9ca3af", lineHeight: 1.8 }}>
                We've set up at baby showers across Calgary — intimate gatherings and large celebrations alike. Every rental includes a professional on-site attendant, custom photo frames themed to your shower, unlimited prints, and full digital delivery after the event.
              </p>
            </div>
          </RevealOnScroll>
        </div>
...
const babyShowerSections: SectionData[] = [
  {
    ...
    body: "Our colorful prop collections are handpicked to match the joy of a baby shower — from silly sticks to sweet keepsake signs. Guests of every age dive in, and the laughter takes care of itself. Whether you're hosting 20 or 120, the booth keeps the energy high.",
  ...
  },
  {
    ...
    imageLeft: false,
    image: "/mirror.jpeg",
    imageAlt: "Mirror photo booth at a baby shower",
    ...
    body: "With unlimited prints included in every package, every guest walks away with a physical photo in hand — not a link to check later. It's the party favour that actually means something.",
  ...
  },
  {
    ...
    imageAlt: "Custom baby shower themed photo frame",
    label: "The Details",
    heading: (
      <>
    ...
    body: "Custom photo frames designed around your shower theme are included in every package at no extra cost. Pastel colours, gender-neutral palettes, baby names — whatever fits your vision, our design team handles it.",
...
const babyShowerFaqs = [
  {
    q: "How far in advance should I book a photo booth for a baby shower?",
  ...
  },
  {
    ...
    a: "Absolutely. Custom-designed photo frames are included in every package at no extra cost. Share your colour palette, theme, or any baby name details and our design team will create a frame that feels personal.",
  },
  {
    q: "What props are included for a baby shower?",
    a: "Our prop collections include a mix of playful baby-themed signs, fun stick props, and accessories that suit guests of all ages. We also accommodate custom prop requests — just let us know what you have in mind when booking.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Our booths support instant sharing to Instagram and Facebook, and guests can also text or email photos directly. You'll also receive a full digital gallery of all photos within 48 hours of the event.",
  },
  {
    q: "What's included in a baby shower photo booth rental?",
  ...
  {
    q: "Do you serve venues outside of Calgary?",
    ...
    <>
      ...
      <main>
        <ActivityHero
          ...
          subtext="Bring fun, laughter, and lasting memories to your baby shower — with custom-themed props, unlimited prints, and a professional setup that lets you enjoy every moment."
          ctaText="Book Your Baby Shower Booth"
          ctaColor="#6C5CE7"
          bgSrc="/baby-shower.jpg"
          bgAlt="Baby shower photo booth setup"
