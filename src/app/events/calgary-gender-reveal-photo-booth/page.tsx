          ...
          <RevealOnScroll direction="left">
            <div>
              <p style={{ fontSize: "clamp(11px, 0.9vw, 13px)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#FF6B35", marginBottom: 20 }}>
                Calgary Gender Reveal Photo Booth Rental
              </p>
          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              <p style={{ fontSize: "clamp(16px, 1.3vw, 20px)", color: "#6b7280", lineHeight: 1.8, marginBottom: 24 }}>
                A Calgary gender reveal photo booth rental captures the excitement, the surprise, and the joy — with themed props and backdrops that make every photo feel part of the celebration.
              </p>
              <p style={{ fontSize: "clamp(15px, 1.1vw, 17px)", color: "#9ca3af", lineHeight: 1.8 }}>
                From intimate family gatherings to large Calgary celebrations, we bring the energy. Every rental includes exclusive Team Boy and Team Girl prop options, custom-designed photo frames, unlimited prints, and full digital delivery so nothing is missed.
              </p>
            </div>
          </RevealOnScroll>
        </div>
...
const genderRevealSections: SectionData[] = [
  {
    ...
    body: "Our Calgary gender reveal photo booth rental adds an interactive, festive element that guests remember long after the big moment. With Team Boy and Team Girl props, vibrant backdrops, and unlimited prints, the whole party becomes part of the announcement.",
  ...
  },
  {
    ...
    body: "Custom photo frames themed to your gender reveal are included in every Calgary photo booth rental at no extra cost. Pink, blue, gender-neutral — whatever direction you're going, our design team creates frames that fit the moment.",
  ...
  },
  {
    ...
    body: "Our Calgary gender reveal photo booth rentals support instant sharing to Instagram and Facebook — guests can post their Team Boy or Team Girl photos in real time and spread the excitement far beyond the party room.",
...
const genderRevealFaqs = [
  {
    q: "How far in advance should I book a Calgary gender reveal photo booth rental?",
  ...
  {
    q: "Do you have Team Boy and Team Girl props for Calgary gender reveals?",
    a: "Yes — our Calgary gender reveal photo booth rental includes exclusive Team Boy and Team Girl stick props, along with a range of colorful accessories and themed signs. Custom prop requests are also welcome when booking.",
  },
  {
    q: "Can the photo frames be customized with pink and blue colours?",
    a: "Absolutely. Custom-designed frames are included in every Calgary photo booth rental at no extra cost. Share your colour palette, theme, and any text or names you'd like and our design team will take it from there.",
  },
  {
    q: "What types of photo booths work best for a Calgary gender reveal?",
  ...
  {
    q: "Can guests share photos to social media from the Calgary photo booth?",
  ...
  {
    q: "What's included in a Calgary gender reveal photo booth rental?",
    ...
    <section style={{ padding: "clamp(80px, 12vw, 180px) 0", background: "#f9f9f9", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 clamp(24px, 5vw, 80px)", position: "relative", zIndex: 1 }}>
        ...
        <AnimatedText
          ...
          stagger={90}
        >
          <AnimLine><span style={{ fontSize: "0.45em", letterSpacing: "-0.02em" }}>Calgary Gender Reveal Photo Booth Rental</span></AnimLine>
    ...
    <>
      ...
      <main>
        <ActivityHero
          ...
          subtext="Capture the excitement and surprise of your Calgary gender reveal — with themed props, vibrant backdrops, and instant prints to commemorate the moment everyone's been waiting for."
        ...
        <BookingCTA
          ...
          headingLine2={<em>Gender Reveal Photo Booth Rental</em>}
        />
      </main>
      <Footer />
    </>
