          ...
          <RevealOnScroll direction="left">
            <div>
              <p style={{ fontSize: "clamp(11px, 0.9vw, 13px)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#FF6B35", marginBottom: 20 }}>
                Calgary Corporate Photo Booth Rental
              </p>
          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              <p style={{ fontSize: "clamp(16px, 1.3vw, 20px)", color: "#6b7280", lineHeight: 1.8, marginBottom: 24 }}>
                A Calgary corporate photo booth rental breaks down walls, gets colleagues laughing together, and creates a shared experience people actually talk about the next day. It's engagement that doesn't feel forced — it just happens naturally.
              </p>
              <p style={{ fontSize: "clamp(15px, 1.1vw, 17px)", color: "#9ca3af", lineHeight: 1.8 }}>
                From Calgary holiday parties and team celebrations to product launches and conferences, we bring a professional setup that reflects your brand. Custom frames featuring your logo, branded backgrounds, and instant social sharing — all handled by our on-site team.
              </p>
            </div>
          </RevealOnScroll>
        </div>
...
const corporateSections: SectionData[] = [
  ...
  },
  {
    ...
    imageAlt: "Branded mirror photo booth at a Calgary corporate event",
    ...
    body2: "Instant social sharing to Instagram, Facebook, and LinkedIn means your Calgary corporate event gets organic coverage in real time. Every post extends your reach without a single paid impression.",
  },
  {
    bg: "#f9f9f9",
    imageLeft: true,
    image: "/corporate-page/festivals-and-events.jpg",
    imageAlt: "Custom corporate branded photo frame and backdrop in Calgary",
    ...
    body: "From branded backdrops featuring your company colours to fully custom frame designs, every element of the Calgary photo booth rental can reflect your corporate identity. Share your brand guidelines and our design team takes it from there.",
  ...
  },
  {
    ...
    body: "Our team coordinates directly with your event organizer or Calgary venue, arrives early to set up, and staffs the booth professionally for the entire rental period. No disruptions, no fumbling — just a clean, seamless experience that reflects well on your company.",
...
const corporateFaqs = [
  {
    q: "How far in advance should I book a Calgary corporate photo booth rental?",
    a: "We recommend booking 4–6 weeks in advance. For large Calgary conferences, holiday parties, or events with specific branding requirements, 8 weeks ahead gives us enough time to execute custom frames and backdrops properly.",
  },
  {
    q: "Can the Calgary photo booth rental be fully branded with our company logo?",
  ...
  {
    q: "What types of photo booths work best for Calgary corporate events?",
    a: "Our mirror booth is popular for Calgary corporate photo booth rentals — it feels premium and interactive, which suits a professional setting well. The classic Salsa Photo Booth handles high volume efficiently. The 360° video booth works especially well as a centerpiece for product launches or large conferences.",
  },
  {
  ...
  {
    q: "What's included in a Calgary corporate photo booth rental?",
  ...
  {
    q: "Do you work with Calgary event planners and corporate venues?",
    ...
    <section style={{ padding: "clamp(80px, 12vw, 180px) 0", background: "#f9f9f9", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 clamp(24px, 5vw, 80px)", position: "relative", zIndex: 1 }}>
        ...
        <AnimatedText
          ...
          stagger={90}
        >
          <AnimLine><span style={{ fontSize: "0.5em", letterSpacing: "-0.02em" }}>Calgary Corporate Photo Booth Rental</span></AnimLine>
    ...
    <>
      ...
      <main>
        <ActivityHero
          ...
          subtext="Elevate your Calgary company event with a branded photo booth experience — custom frames, instant social sharing, and unlimited prints that double as branded take-homes for every attendee."
          ctaText="Book Your Corporate Booth"
          ctaColor="#00B894"
          bgSrc="/corporate.jpg"
          bgAlt="Calgary corporate event photo booth setup"
        ...
        <BookingCTA
          ...
          headingLine2={<em>Corporate Photo Booth Rental</em>}
        />
      </main>
      <Footer />
    </>
