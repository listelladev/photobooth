      ...
      >
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="Calgary wedding photo booth setup"
        ...
        <div className="absolute" style={{ top: "12%", right: "7%", zIndex: 5 }}>
          <div style={{ transition: "transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.25s ease", transform: sticker1 ? "scale(1) rotate(-6deg)" : "scale(0) rotate(-18deg)", opacity: sticker1 ? 1 : 0 }}>
            <img src="/icons/Asset%2011wedding-ring.svg" alt="" style={{ width: "clamp(64px, 7vw, 108px)", height: "auto" }} />
          </div>
        </div>
        ...
        <div className="absolute" style={{ bottom: "20%", right: "5%", zIndex: 5 }}>
          <div style={{ transition: "transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.25s ease", transform: sticker2 ? "scale(1) rotate(8deg)" : "scale(0) rotate(20deg)", opacity: sticker2 ? 1 : 0 }}>
            <img src="/icons/Asset%2010champagne.svg" alt="" style={{ width: "clamp(44px, 5vw, 76px)", height: "auto" }} />
          </div>
        </div>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "clamp(72px, 9vw, 116px) clamp(28px, 6vw, 100px) clamp(8px, 1vw, 12px)" }}>
          ...
          <div style={{ overflow: "hidden", paddingBottom: "0.18em", marginBottom: "-0.18em" }}>
            <p ref={subRef} style={{ fontSize: "clamp(16px, 1.3vw, 20px)", fontWeight: 400, color: "rgba(255,255,255,0.6)", maxWidth: 680, lineHeight: 1.7, transform: "translateY(20px)", opacity: 0, transition: "transform 0.9s cubic-bezier(0.22,1,0.36,1) 0.5s, opacity 0.9s cubic-bezier(0.22,1,0.36,1) 0.5s" }}>
              Calgary wedding photo booth rentals — from intimate ceremonies to grand receptions. Setup, attendant, and digital delivery always included.
            </p>
          </div>
          ...
          <RevealOnScroll direction="left">
            <div>
              <p style={{ fontSize: "clamp(11px, 0.9vw, 13px)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#FF6B35", marginBottom: 20 }}>
                Calgary Wedding Photo Booth Rental
              </p>
          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              ...
              <p style={{ fontSize: "clamp(15px, 1.1vw, 17px)", color: "#9ca3af", lineHeight: 1.8 }}>
                We've set up Calgary wedding photo booth rentals at venues across Calgary and Alberta, from intimate ceremonies of 30 to grand receptions of 400. Every rental comes with a professional on-site attendant, custom-designed photo frames, unlimited prints, and full digital delivery after the event.
              </p>
            </div>
          </RevealOnScroll>
        </div>
...
const weddingSections: SectionData[] = [
  ...
  },
  {
    ...
    imageAlt: "Mirror photo booth with couple at a Calgary wedding",
  ...
  },
  {
    ...
    imageAlt: "360 degree photo booth at a Calgary wedding",
    label: "Hassle-Free",
    heading: (
      <>
...
const weddingFaqs = [
  {
    q: "How far in advance should I book a Calgary wedding photo booth rental?",
    a: "We recommend booking at least 6–8 weeks in advance for weddings, particularly for dates between May and October when demand is highest. Popular Calgary venues book quickly — the earlier, the better.",
  },
  {
    q: "What types of photo booths work best for Calgary weddings?",
    a: "Our mirror booth is the most popular choice for Calgary wedding photo booth rentals — it adds an elegant, interactive element that photographs beautifully. The classic Salsa Photo Booth is perfect for higher-volume events. The 360° video booth is a show-stopper for larger receptions.",
  },
  {
    q: "Can I customize the photo frames with our wedding monogram?",
    a: "Absolutely. Custom-designed photo frames are included in every Calgary wedding photo booth rental at no extra cost. Send us your wedding colours, monogram, or theme inspiration and our design team takes care of the rest.",
  },
  {
  ...
  {
    q: "What's included in a wedding photo booth rental in Calgary?",
    a: "Every Calgary wedding photo booth rental includes your choice of photo booth, a professional on-site attendant for the full rental period, complete setup and takedown, unlimited instant prints, a curated props collection, and a custom-designed photo frame. Digital delivery of all photos is included after the event.",
  },
  {
    q: "Do you travel to wedding venues outside Calgary?",
    ...
    <section style={{ padding: "clamp(80px, 12vw, 180px) 0", background: "#f9f9f9", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 clamp(24px, 5vw, 80px)", position: "relative", zIndex: 1 }}>
        ...
        <AnimatedText
          ...
          stagger={90}
        >
          <AnimLine><span style={{ fontSize: "0.55em", letterSpacing: "-0.02em" }}>Calgary Wedding Photo Booth Rental</span></AnimLine>
    ...
    <>
      ...
      <main>
        ...
        <BookingCTA
          ...
          headingLine2={<em>Wedding Photo Booth Rental</em>}
        />
      </main>
      <Footer />
    </>
