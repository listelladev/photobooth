          ...
          <RevealOnScroll direction="left">
            <div>
              <p style={{ fontSize: "clamp(11px, 0.9vw, 13px)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#FF6B35", marginBottom: 20 }}>
                Calgary Birthday Photo Booth Rental
              </p>
          ...
          <RevealOnScroll direction="right" delay={150}>
            <div style={{ paddingTop: "clamp(0px, 2vw, 40px)" }}>
              <p style={{ fontSize: "clamp(16px, 1.3vw, 20px)", color: "#6b7280", lineHeight: 1.8, marginBottom: 24 }}>
                A Calgary birthday photo booth rental is the party entertainment that runs itself — guests grab props, jump in, and walk away with a physical print that actually means something. It creates energy in any room and keeps guests engaged all night long.
              </p>
...
const birthdaySections: SectionData[] = [
  {
    ...
    body: "Our Calgary birthday photo booth rental creates a lively atmosphere that pulls people together — it's the activity guests actually look forward to. With a wide variety of props and our friendly on-site attendant keeping things moving, the energy stays high from the first click to the last.",
  ...
  },
  {
    ...
    imageAlt: "Mirror photo booth at a birthday party in Calgary",
    label: "Props & Fun",
    heading: (
      <>
  ...
  },
  {
    ...
    imageAlt: "Custom birthday themed photo frame in Calgary",
    label: "Personalized",
    heading: (
      <>
    ...
    body: "Custom-designed photo frames are included in every Calgary birthday photo booth rental at no extra cost. Tell us your theme, colours, and any text you want — our design team takes it from there and creates something that feels like it was made for your night.",
...
const birthdayFaqs = [
  {
    q: "How far in advance should I book a Calgary birthday photo booth rental?",
    a: "We recommend booking 3–4 weeks in advance. For milestone birthdays or larger Calgary events, 6–8 weeks ahead is ideal to secure your preferred date and booth style.",
  },
  {
    q: "Can photo frames be customized for a birthday theme?",
    a: "Yes — custom-designed frames are included in every Calgary birthday photo booth rental at no extra cost. Share your theme, colour palette, or any text you'd like and our design team will create something that fits your party perfectly.",
  },
  {
    q: "What types of photo booths work best for birthday parties in Calgary?",
  ...
  {
    q: "Can guests share photos on social media from the Calgary photo booth?",
  ...
  {
    q: "What's included in a Calgary birthday photo booth rental?",
  ...
  {
    q: "Do you travel to birthday venues outside Calgary?",
    ...
    <section style={{ padding: "clamp(80px, 12vw, 180px) 0", background: "#f9f9f9", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 clamp(24px, 5vw, 80px)", position: "relative", zIndex: 1 }}>
        ...
        <AnimatedText
          ...
          stagger={90}
        >
          <AnimLine><span style={{ fontSize: "0.55em", letterSpacing: "-0.02em" }}>Calgary Birthday Photo Booth Rental</span></AnimLine>
    ...
    <>
      ...
      <main>
        <ActivityHero
          ...
          subtext="Make your Calgary birthday unforgettable — with a photo booth that keeps guests entertained, unlimited prints to take home, and memories that last long after the cake is gone."
        ...
        <BookingCTA
          ...
          headingLine2={<em>Birthday Photo Booth Rental</em>}
        />
      </main>
      <Footer />
    </>
